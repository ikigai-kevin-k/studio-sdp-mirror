...
def load_config():
    ...
    try:
        with open(config_path, "r") as f:
            configs = json.load(f)
            # Find PRD-5 configuration
            for config in configs:
                if config["name"] == "PRD-5":
                    return config
...
if config:
    ...
    accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uSWQiOiJmNTk2NzFiOC0xNDY4LTQ3Y2ItOTExNS03NDA5MGUwOTdjNzMiLCJnYW1lQ29kZSI6WyJBUk8tMDA1Il0sInJvbGUiOiJzZHAiLCJjcmVhdGVkQXQiOjE3NjA0MzE5OTA4NDMsImlhdCI6MTc2MDQzMTk5MH0.5Bebn3_PCn_sJ6s4ZqrdfTTd2Jo5HylXM7bY6dVVKp0"
    gameCode = "ARO-005"
