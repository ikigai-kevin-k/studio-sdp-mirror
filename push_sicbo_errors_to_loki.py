#!/usr/bin/env python3
"""
Monitor sbo_{yyyy-mm-dd}.log files for ERROR|Error|error lines and push to Loki server
...
POSITION_FILE = os.path.join(os.path.dirname(__file__), ".last_position_sicbo_errors.json")
...
def main():
    ...
    print("=" * 60)
    print("SicBo Error Log Monitor - Push to Loki Server")
    print("=" * 60)
    print(f"Loki Server: {LOKI_URL}")
    ...
    print(f'  {{job="sicbo_error_logs"}}')
    print(f'  {{job="sicbo_error_logs", game_type="sicbo"}}')
    print("=" * 60)
