...
def get_access_token():
    ...
    data = {"gameCode": "BAC-005", "role": "sdp"}
...
accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uSWQiOiIxZGI1N2Y1OC1mODcwLTQ3OGYtOTA0NS0zMWZmZTRiNmVmNDIiLCJnYW1lQ29kZSI6WyJCQUMtMDA1Il0sInJvbGUiOiJzZHAiLCJjcmVhdGVkQXQiOjE3NTYzNjUzMjYzNTYsImlhdCI6MTc1NjM2NTMyNn0.sC32XTX5Tuh3WcEXouog8wOg8qgx7cv_1a0WSoBhiKQ"
...
def swap_card_format(cards_list):
    """
    ...
    for card in cards_list:
        ...
        if card.startswith("10"):
            ...
            swapped_cards.append(f"{suit}10")
        # Handle single digit or letter
        elif len(card) == 2:
            number = card[0]
            suit = card[1]
            swapped_cards.append(f"{suit}{number}")
        else:
...
if __name__ == "__main__":
    ...
    while cnt < 1:
        ...
        # gameCode = 'SDP-001'
        # gameCode = 'SDP-003'
        gameCode = "BAC-005"  # Changed to match the token's gameCode
        # gameCode = 'ABO-001'
        # gameCode = 'SBO-004'
