...
# QAT ARO-002
accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uSWQiOiIxY2Q4OGRiNi04MTA1LTRmYzgtYWIyNi1jNWZkNTgwNTRlMDciLCJnYW1lQ29kZSI6WyJBUk8tMDAyIl0sInJvbGUiOiJzZHAiLCJjcmVhdGVkQXQiOjE3NTE2MDY0MjcwMDgsImlhdCI6MTc1MTYwNjQyN30.BCFPedJM5Fsmr3xQ-Lel9aTz65AxzDJICyHk2xCd1jk"
...
def bet_stop_post_qat(url: str, token: str) -> bool:
    """
    Stop betting for the current round - Virtual Roulette game (QAT environment)
