...
def session_get(url: str, game_code: str) -> str:
    ...
    try:
        response = requests.post(
            f"{url}/sessions", headers=headers, json=data, verify=False
        )
...
# DEV SBO-001
accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uSWQiOiJlYWVkMzhiOC1lZTVkLTRhOTgtOWM3ZS0xZmIzN2Q4YzhkYWUiLCJnYW1lQ29kZSI6WyJTQk8tMDAxIl0sInJvbGUiOiJzZHAiLCJjcmVhdGVkQXQiOjE3NjQxMjM5ODA1NzcsImlhdCI6MTc2NDEyMzk4MH0.INWLvsi7C69hsONcpNDltQDkwwi6XExwmvomUXzw1VM"
...
def bet_stop_post_dev(url: str, token: str) -> None:
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="SicBo API script for DEV environment"
    )
    parser.add_argument(
        "--result",
        type=str,
    ...
    cnt = 0
    while cnt < 1:
        get_url = "https://crystal-table.iki-dev.cc/v2/service/tables/"
        post_url = "https://crystal-table.iki-dev.cc/v2/service/tables/"
