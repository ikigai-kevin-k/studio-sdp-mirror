...
def load_config():
    ...
    try:
        with open(config_path, "r") as f:
            configs = json.load(f)
            # Find PRD-6 configuration
            for config in configs:
                if config["name"] == "PRD-6":
                    return config
...
if config:
    ...
    accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uSWQiOiIwMzEyZTVlYS1lN2UyLTQwNmQtYTk0NC0zMjQ5OTBhZThmOTEiLCJnYW1lQ29kZSI6WyJBUk8tMDA2Il0sInJvbGUiOiJzZHAiLCJjcmVhdGVkQXQiOjE3NjA0MzIwNTMzNjAsImlhdCI6MTc2MDQzMjA1M30.rI4uFwxgyO24RF1xxthLlcPCHz2P3I9nvCjOSFL0p8A"
    gameCode = "ARO-006"
