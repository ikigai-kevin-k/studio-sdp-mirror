...
# GLC ARO-001
accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uSWQiOiIxYTQ1MGFkYy1kYTI0LTQ2ZGQtYTdmOS01ZmJiOWUyNjg4YmIiLCJnYW1lQ29kZSI6WyJBUk8tMDAxIl0sInJvbGUiOiJzZHAiLCJjcmVhdGVkQXQiOjE3NjI1MDg0NzQwMTUsImlhdCI6MTc2MjUwODQ3NH0.j49wrkExFys3EKjbQhGmZPq4yb7YvkvRkoGXZltgxHA"
...
def bet_stop_post_glc(url: str, token: str) -> bool:
    """
    Stop betting for the current round - Speed Roulette game (GLC environment)
