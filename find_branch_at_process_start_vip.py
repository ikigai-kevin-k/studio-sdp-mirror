...
VIP version for main_vip.py processes.
"""
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python3 find_branch_at_process_start_vip.py <pid>")
        print("  python3 find_branch_at_process_start_vip.py --name <process_name>")
        print("  python3 find_branch_at_process_start_vip.py --tmux <session_name>")
        print("\nExample:")
        print("  python3 find_branch_at_process_start_vip.py 19340")
        print("  python3 find_branch_at_process_start_vip.py --name main_vip.py")
        print("  python3 find_branch_at_process_start_vip.py --tmux dp:vip")
        sys.exit(1)
