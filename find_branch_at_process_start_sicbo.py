...
SicBo version for main_sicbo.py processes.
"""
...
def main():
    ...
    if len(sys.argv) < 2:
        print("Usage:")
        print("  python3 find_branch_at_process_start_sicbo.py <pid>")
        print("  python3 find_branch_at_process_start_sicbo.py --name <process_name>")
        print("  python3 find_branch_at_process_start_sicbo.py --tmux <session_name>")
        print("\nExample:")
        print("  python3 find_branch_at_process_start_sicbo.py 19340")
        print("  python3 find_branch_at_process_start_sicbo.py --name main_sicbo.py")
        print("  python3 find_branch_at_process_start_sicbo.py --tmux dp:sicbo")
        sys.exit(1)
