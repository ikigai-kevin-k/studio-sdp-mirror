...
# across all environments (DEV, CIT, UAT, QAT, STG, PRD, GLC) in parallel.
...
usage() {
    ...
    echo "across all environments (DEV, CIT, UAT, QAT, STG, PRD, GLC) in parallel."
    echo ""
...
main() {
    ...
    # All environments
    local environments=("DEV" "CIT" "UAT" "QAT" "STG" "PRD" "GLC")
