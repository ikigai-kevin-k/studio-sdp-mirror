...
class APIv2AllRunner:
    ...
    def run_single_api_script(self, env_name: str, script_name: str) -> Tuple[str, bool, float, str]:
        """
        執行單個 API 腳本
        ...
        try:
            ...
            if result.returncode == 0:
                ...
                return env_name, False, execution_time, f"Error: {result.stderr}"
    ...
    def run_all_parallel(self) -> Dict[str, Dict]:
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=5) as executor:
            # 提交所有任務
            future_to_env = {
                executor.submit(self.run_single_api_script, env_name, script_name): env_name
    ...
    def run_all_sequential(self) -> Dict[str, Dict]:
        ...
        for env_name, script_name in self.api_scripts.items():
            ...
            env_name, success, execution_time, output = self.run_single_api_script(env_name, script_name)
    ...
    def print_summary(self):
        ...
        for env_name, result in self.results.items():
            ...
            print(f"{env_name:>6}: {status:>12} | {result['execution_time']:>6.2f}s")
