#!/usr/bin/env python3
"""
Analyze VIP Roulette log files to extract game round total time
Scans all vip_{yyyy}-{mm}-{dd}.log files and extracts Summary section
Calculates total game round time = start_to_launch_time + launch_to_deal_time + deal_to_finish_time
Outputs statistics to vip_game_round.csv
"""
...
# Format:
# [2025-11-10 02:09:04.506] Receive >>> Summary:
# [2025-11-10 02:09:04.506] Receive >>> start_to_launch_time: 5.503629207611084
# [2025-11-10 02:09:04.506] Receive >>> launch_to_deal_time: 43.50457954406738
# [2025-11-10 02:09:04.506] Receive >>> deal_to_finish_time: 0.4448878765106201
...
def main():
    """Main function"""
    print("=" * 60)
    print("VIP Roulette Game Round Time Analyzer")
    print("=" * 60)
    ...
    output_file = "vip_game_round.csv"
    ...
    print(f"\n💡 Next step: Run 'python analyze_vip_game_round_time_stats.py' to analyze the statistics")
