...
def test_vip_roulette_sensor_error_notification(channel: str = "#studio-rnd", mention_user: str = "Mark Bochkov"):
    ...
    try:
        ...
        # 6. Channel: Specified channel (#studio-rnd or #ge-studio)
...
def main():
    ...
    if len(sys.argv) > 1:
        ...
        if channel_arg == "ge-studio":
            ...
            logger.info("   Valid options: ge-studio, studio-rnd, rnd-studio")
    else:
        logger.info("📢 No channel specified, using default: studio-rnd with Mark Bochkov")
        logger.info("   Usage: python3 slack/test_vip_roulette_sensor_error.py [ge-studio|studio-rnd|rnd-studio]")
