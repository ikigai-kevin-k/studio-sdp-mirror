...
class StudioWebSocketServer:
    ...
    async def handle_connection(self, websocket: WebSocketServerProtocol):
        ...
        try:
            ...
            welcome_msg = {"message": "Connected to Studio WebSocket Server", "status": "ready"}
            ...
            logger.info(f"Connection closed for {user_id if 'user_id' in locals() else 'unknown'}")
    ...
    async def _handle_status_update(self, websocket: WebSocketServerProtocol, table_id: str, message: str):
