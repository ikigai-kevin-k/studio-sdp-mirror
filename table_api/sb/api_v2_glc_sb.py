...
# GLC SBO-001
accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzZXNzaW9uSWQiOiJlZmZjMTAyOC1lYjRhLTRhMjgtYWYyMy1kNjEwYWJiYjVlNGIiLCJnYW1lQ29kZSI6WyJTQk8tMDAxIl0sInJvbGUiOiJzZHAiLCJjcmVhdGVkQXQiOjE3NjI1MDgyOTUxNDMsImlhdCI6MTc2MjUwODI5NX0.M_uab7i797utJ8sV0V6tF8Bd4JrUxkL7bNLChHNaMLE"
...
def deal_post_v2_glc(url, token, round_id, result):
    ...
    data = {
        "roundId": f"{round_id}",
        "sicBo": result,  # SicBo game uses "sicBo" field
    }
...
def bet_stop_post_glc(url: str, token: str) -> bool:
    """
    Stop betting for the current round - SicBo game (GLC environment)
...
if __name__ == "__main__":
    ...
    while cnt < 1:
        ...
        # broadcast_post(post_url, token, "dice.reshake", "players", 20)
