...
def test_sicbo_start_post_failed_notification(
    channel: str = "#ge-studio", mention_user: str = "Kevin Kuo", environment: str = "STG"
):
    """
    ...
    try:
        ...
        # 7. Channel: Specified channel (#ge-studio or other)
...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="#ge-studio",
        help="Slack channel to send to (default: #ge-studio)",
    )
    parser.add_argument(
        "--mention-user",
        type=str,
